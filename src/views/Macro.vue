...
<el-container>
  <el-main>
    ...
    <el-row>
      <el-col>
        <ve-wordcloud v-loading="!hawk.h.length" :settings="{ sizeMax: 96, sizeMin: 12 }" :data="{ columns: ['word', 'weight'], rows: hawk.h }" :extend="wordCloudExtend"></ve-wordcloud>
      </el-col>
    </el-row>
    <h1>24小时直播弹幕</h1>
    <el-row>
      <el-col>
        <ve-wordcloud v-loading="!hawk.day.length" :settings="{ sizeMax: 96, sizeMin: 12 }" :data="{ columns: ['word', 'weight'], rows: hawk.day }" :extend="wordCloudExtend"></ve-wordcloud>
      </el-col>
    </el-row>
    <h1>虚拟世界宏观经济走势</h1>
    <el-row>
